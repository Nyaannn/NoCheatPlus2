...
scoreboard players set @a climb1sec 0
scoreboard players set @a jump1sec 0
scoreboard players set @a pig1sec 0
scoreboard players set @a strider1sec 0
scoreboard players set @a horse1sec 0


schedule function nyaann:flags/resetflags 1s